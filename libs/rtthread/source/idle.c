 ...
 * 2021-11-15     THEWON       Remove duplicate work between idle and
 * _thread_exit
 */
 ...
 *
 * @note It must be called between rt_hw_interrupt_disable and
...
void rt_thread_idle_init(void)
{
    ...
    for (i = 0; i < _CPUS_NR; i++)
    {
        ...
        rt_thread_init(&idle[i], tidle_name, rt_thread_idle_entry, NULL,
    ...
    rt_thread_init(&rt_system_thread, "tsystem", rt_thread_system_entry, NULL,
                   rt_system_stack, sizeof(rt_system_stack),
