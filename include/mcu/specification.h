...
/* Flash0规格参数 */
#define MCU_FLASH_SECTOR_SIZE   (128 * 1024) // Flash扇区大小
#define MCU_FLASH0_START        0x08000000   // Flash0起始地址
#define MCU_FLASH0_SECTOR_COUNT 8            // Flash0扇区数量
...
#define MCU_FLASH1_SECTOR_COUNT 8                       // Flash1扇区数量
#endif
...
#define MCU_ITCM_SIZE   (64 * 1024 - 0x400)            // ITCM大小
#endif
...
#define MCU_DTCM_SIZE  (128 * 1024) // DTCM大小
#endif
...
#define MCU_RAM0_SIZE  (512 * 1024) // RAM0大小
#endif
...
#define MCU_RAM1_SIZE  (288 * 1024) // RAM1大小
#endif
